...
Sekiro: no README or manifest to go on; based on its name, this looks like a personal project — open the repository to confirm.

[![CI](https://github.com/anyingiit/Sekiro/actions/workflows/ci.yml/badge.svg)](https://github.com/anyingiit/Sekiro/actions/workflows/ci.yml)
...
See the [open issues](https://github.com/anyingiit/Sekiro/issues) for planned features and known issues.
